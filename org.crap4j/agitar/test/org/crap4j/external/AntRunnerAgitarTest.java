 ...
 *
 * Generated on Oct 26, 2007 3:58:50 PM
 * Time to generate: 00:20.412 seconds
 *
 */
...
public class AntRunnerAgitarTest extends AgitarTestCase {
    ...
    public void testConstructor() throws Throwable {
        ...
        assertEquals("antRunner.antHome", "testAntRunnerAntHome", getPrivateField(antRunner, "antHome"));
        assertEquals("antRunner.debug", Boolean.TRUE, getPrivateField(antRunner, "debug"));
        assertEquals("antRunner.agitatorEclipseApiPluginDir", "testAntRunnerAgitatorEclipseApiPluginDir", getPrivateField(antRunner, "agitatorEclipseApiPluginDir"));
        assertEquals("antRunner.antFile", "testAntRunnerAntFile", getPrivateField(antRunner, "antFile"));
        assertEquals("antRunner.junitLib", "testAntRunnerJunitLib", getPrivateField(antRunner, "junitLib"));
    }
    ...
    public void testCheckExitStatusThrowsRuntimeException() throws Throwable {
        AntRunner antRunner = new AntRunner("testAntRunnerAntFile", "testAntRunnerAntHome", "testAntRunnerJunitLib", "testAntRunnerAgitatorEclipseApiPluginDir", true);
        try {
            callPrivateMethod("org.crap4j.external.AntRunner", "checkExitStatus", new Class[] {int.class}, antRunner, new Object[] {new Integer(100)});
            fail("Expected RuntimeException to be thrown");
        } catch (RuntimeException ex) {
            assertEquals("ex.getMessage()", "Ant run failed with status: 100", ex.getMessage());
