 ...
 *
 * Generated on Nov 27, 2007 4:13:38 PM
 * Time to generate: 01:19.917 seconds
 *
 */
...
public class AntBuilderAgitarTest extends AgitarTestCase {
    ...
    public void testBuildContent() throws Throwable {
        List arrayList = new ArrayList();
        arrayList.add("sourcedirs");
        CrapProject crapProject = new CrapProject("projectDir", new ArrayList(), new ArrayList(), new ArrayList(), arrayList, "");
        AntBuilder antBuilder = new AntBuilder("testAntBuilderParam1", "testAntBuilderParam2");
        String result = antBuilder.buildContent(crapProject);
        assertEquals("result", "<?xml version=\"1.0\" ?>\n<project name=\"projectDir\" default=\"agitar-all\">\n\n\t<!-- Use of ${project.dir.projectDir} allows for the resolution of relative paths even when this file is imported in another build file -->\n\t<dirname file=\"${ant.file.projectDir}\" property=\"import.dir.projectDir\"/>\n\t<condition property=\"project.dir.projectDir\" value=\"${import.dir.projectDir}\" else=\"${basedir}\">\n<isset property=\"import.dir.projectDir\"/>\n\t</condition>\n\n<taskdef name=\"super-runner\" classname=\"com.agitar.junit.runner.SuperRunnerTask\">\n<classpath>\n\t\t<pathelement location=\"testAntBuilderParam1/com.agitar.common.jar\" />\n\t\t<pathelement location=\"testAntBuilderParam1/com.agitar.coverage.jar\" />\n\t\t<pathelement location=\"testAntBuilderParam2/com.agitar.mockingbird.jar\" />\n\t  <pathelement location=\"testAntBuilderParam2/com.agitar.testrunner.jar\" />\n\t\t<fileset dir=\"testAntBuilderParam2/lib\">\n\t\t  <include name=\"**/*.jar\" />\n    </fileset>\n    <fileset dir=\"testAntBuilderParam1/lib\">\n\t    <include name=\"**/*.jar\" />\n    </fileset>\n  </classpath>\n</taskdef>\n\t\n\t\n\t<!-- Default target -->\n\t<target name=\"agitar-all\" depends=\"run-tests\"/>\n\t\n\t\n\t<!-- Cleans old agitation results and coverage -->\n\t<target name=\"clean-results\">\n\t\t<delete dir=\"${basedir}/agitar/.results\" quiet=\"true\"/>\n\t</target>\n\t\n\t<!-- Run the tests for this project -->\n\n\t<target name=\"run-tests\">\n\t\t<property name=\"test.results.dir\" value=\"${project.dir.projectDir}/agitar/.junitresults\"/>\n\t\t<mkdir dir=\"${test.results.dir}\"/>\n\t\t<super-runner dir=\"${basedir}\" batchSize=\"5\" printsummary=\"yes\" mergeCoverage=\"true\" haltonfailure=\"no\" resultsDir=\"${project.dir.projectDir}/agitar/.results\">\n\t\t\t<jvmarg value=\"-Xmx512M\"/>\n\t\t\t<jvmarg value=\"-ea\"/>\n\t\t\t<jvmarg value=\"-Djava.awt.headless\"/>\n\t\t\t<formatter type=\"xml\"/>\n\t\t\t<classpath>\n         \t\t\t</classpath>\n\t\t\t<batchtest todir=\"${test.results.dir}\">\n        \t\t\t</batchtest>\n\t\t</super-runner>\n\t</target>\n\t\n</project>", result);
    }
    
    public void testBuildContent1() throws Throwable {
        List arrayList = new ArrayList();
        arrayList.add("testclasses");
        CrapProject crapProject = new CrapProject("projectDir", new ArrayList(), arrayList, new ArrayList(), new ArrayList(), "");
        AntBuilder antBuilder = new AntBuilder("testAntBuilderParam1", "testAntBuilderParam2");
        String result = antBuilder.buildContent(crapProject);
    ...
    public void testBuildFileForProjectWithAggressiveMocks() throws Throwable {
        ...
        Mockingbird.setReturnValue(false, Mockingbird.getProxyObject(String.class), "replaceAll", "(java.lang.String,java.lang.String)java.lang.String", "", 1);
        Mockingbird.setReturnValue(false, Mockingbird.getProxyObject(String.class), "replaceAll", "(java.lang.String,java.lang.String)java.lang.String", "", 1);
        Mockingbird.setReturnValue(false, antBuilder, "makeForwardSlash", "(java.lang.String)java.lang.String", new Object[] {""}, "", 1);
        Mockingbird.setReturnValue(false, Mockingbird.getProxyObject(String.class), "replaceAll", "(java.lang.String,java.lang.String)java.lang.String", "", 1);
    ...
    public void testReplacePathElementsForPatternThrowsNullPointerException() throws Throwable {
        ...
        arrayList.add("");
        try {
            new AntBuilder("testAntBuilderParam1", "testAntBuilderParam2").replacePathElementsForPattern(arrayList, "testAntBuilderParam2", null);
            fail("Expected NullPointerException to be thrown");
        } catch (NullPointerException ex) {
            assertNull("ex.getMessage()", ex.getMessage());
            assertThrownBy(AntBuilder.class, ex);
