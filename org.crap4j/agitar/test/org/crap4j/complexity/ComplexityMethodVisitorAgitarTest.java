 ...
 *
 * Generated on Oct 26, 2007 3:57:54 PM
 * Time to generate: 00:20.365 seconds
 *
 */
...
public class ComplexityMethodVisitorAgitarTest extends AgitarTestCase {
    ...
    public void testCompute() throws Throwable {
        ...
        int result = complexityMethodVisitor.compute();
        assertEquals("result", 0, result);
    }
    
    public void testCompute1() throws Throwable {
    ...
    public void testNullAnnotationVisitorVisit() throws Throwable {
        ComplexityMethodVisitor.NullAnnotationVisitor annotation = (ComplexityMethodVisitor.NullAnnotationVisitor) new ComplexityMethodVisitor.NullAnnotationVisitor().visitAnnotation("testNullAnnotationVisitorName", "testNullAnnotationVisitorDesc");
        annotation.visit("testNullAnnotationVisitorName", new Integer(-2));
        assertTrue("Test call resulted in expected outcome", true);
    }
    ...
    public void testVisitAnnotation() throws Throwable {
        ComplexityMethodVisitor.NullAnnotationVisitor result = (ComplexityMethodVisitor.NullAnnotationVisitor) new ComplexityMethodVisitor().visitAnnotation("testComplexityMethodVisitorDesc", true);
        assertNotNull("result", result);
    }
    ...
    public void testVisitFieldInsn() throws Throwable {
        ComplexityMethodVisitor complexityMethodVisitor = new ComplexityMethodVisitor();
        complexityMethodVisitor.visitFieldInsn(100, "testComplexityMethodVisitorOwner", "testComplexityMethodVisitorName", "testComplexityMethodVisitorDesc");
        assertEquals("complexityMethodVisitor.edges", new Integer(1), getPrivateField(complexityMethodVisitor, "edges"));
    }
    ...
    public void testVisitFrame() throws Throwable {
        ...
        complexityMethodVisitor.visitFrame(100, 1000, local, 0, local);
        assertEquals("complexityMethodVisitor.compute()", 2, complexityMethodVisitor.compute());
    }
    ...
    public void testVisitJumpInsn1() throws Throwable {
        ComplexityMethodVisitor complexityMethodVisitor = new ComplexityMethodVisitor();
        callPrivateMethod("org.crap4j.complexity.ComplexityMethodVisitor", "visitJumpInsn", new Class[] {int.class, Class.forName("com.agitar.org.objectweb.asm.Label")}, complexityMethodVisitor, new Object[] {new Integer(154), null});
        assertEquals("complexityMethodVisitor.edges", new Integer(2), getPrivateField(complexityMethodVisitor, "edges"));
        assertEquals("complexityMethodVisitor.complexity", 2, complexityMethodVisitor.complexity);
    }
    ...
    public void testVisitMethodInsn() throws Throwable {
        ComplexityMethodVisitor complexityMethodVisitor = new ComplexityMethodVisitor();
        complexityMethodVisitor.visitMethodInsn(100, "testComplexityMethodVisitorOwner", "testComplexityMethodVisitorName", "testComplexityMethodVisitorDesc");
        assertEquals("complexityMethodVisitor.edges", new Integer(1), getPrivateField(complexityMethodVisitor, "edges"));
    }
    
    public void testVisitMultiANewArrayInsn() throws Throwable {
        ComplexityMethodVisitor complexityMethodVisitor = new ComplexityMethodVisitor();
        complexityMethodVisitor.visitMultiANewArrayInsn("testComplexityMethodVisitorDesc", 100);
        assertEquals("complexityMethodVisitor.edges", new Integer(1), getPrivateField(complexityMethodVisitor, "edges"));
    }
    
    public void testVisitParameterAnnotation() throws Throwable {
        ComplexityMethodVisitor.NullAnnotationVisitor result = (ComplexityMethodVisitor.NullAnnotationVisitor) new ComplexityMethodVisitor().visitParameterAnnotation(100, "testComplexityMethodVisitorDesc", true);
        assertNotNull("result", result);
    }
    
    public void testVisitTableSwitchInsn() throws Throwable {
        ComplexityMethodVisitor complexityMethodVisitor = new ComplexityMethodVisitor();
        Object[] instance = (Object[]) Array.newInstance(Class.forName("com.agitar.org.objectweb.asm.Label"), new int[] {1});
    ...
    public void testVisitTypeInsn() throws Throwable {
        ComplexityMethodVisitor complexityMethodVisitor = new ComplexityMethodVisitor();
        complexityMethodVisitor.visitTypeInsn(100, "testComplexityMethodVisitorDesc");
        assertEquals("complexityMethodVisitor.edges", new Integer(1), getPrivateField(complexityMethodVisitor, "edges"));
    }
