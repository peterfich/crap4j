 ...
 *
 * Generated on Nov 27, 2007 4:11:47 PM
 * Time to generate: 00:17.423 seconds
 *
 */
...
public class StatsDownloaderAgitarTest extends AgitarTestCase {
    ...
    public void testConstructor() throws Throwable {
        StatsDownloader statsDownloader = new StatsDownloader("testStatsDownloaderParam1");
        assertEquals("statsDownloader.host", "testStatsDownloaderParam1", statsDownloader.host);
    }
    ...
    public void testGetAverage2() throws Throwable {
        GlobalStats result = new StatsDownloader("testStatsDownloaderParam1").getAverage(true);
        assertEquals("result.getCrapAverage()", -1.0F, result.getCrapAverage(), 1.0E-6F);
    }
