 ...
 *
 * Generated on Nov 1, 2007 12:03:02 AM
 * Time to generate: 01:33.396 seconds
 *
 */
...
public class NewCrapImageGeneratorAgitarTest extends AgitarTestCase {
    ...
    public void testConstructor() throws Throwable {
        NewCrapImageGenerator newCrapImageGenerator = new NewCrapImageGenerator(100.0F, "testNewCrapImageGeneratorParam2", " ", true, 1000.0F);
    ...
    public void testConstructor2() throws Throwable {
        NewCrapImageGenerator newCrapImageGenerator = new NewCrapImageGenerator(100.0F, "testNewCrapImageGeneratorParam2", null, true, 1000.0F);
        assertEquals("newCrapImageGenerator.dir", "testNewCrapImageGeneratorParam2", getPrivateField(newCrapImageGenerator, "dir"));
        float actual = ((Image) getPrivateField(newCrapImageGenerator, "gauge")).getAccelerationPriority();
        assertEquals("newCrapImageGenerator.gauge.getAccelerationPriority()", 0.5F, actual, 1.0E-6F);
        assertEquals("newCrapImageGenerator.crapScore", new Float(100.0F), getPrivateField(newCrapImageGenerator, "crapScore"));
    ...
    public void testMakeGaugeAndWriteToFile() throws Throwable {
        NewCrapImageGenerator newCrapImageGenerator = new NewCrapImageGenerator(-1.0F, "testNewCrapImageGeneratorParam2", "testNewCrapImageGeneratorParam3", true, 100.0F);
        newCrapImageGenerator.makeGaugeAndWriteToFile();
        assertTrue("Test call resulted in expected outcome", true);
    }
    
    public void testMakeGaugeAndWriteToFile1() throws Throwable {
        NewCrapImageGenerator newCrapImageGenerator = new NewCrapImageGenerator(15.030015F, "testNewCrapImageGeneratorParam2", "testNewCrapImageGeneratorParam3", true, 100.0F);
        newCrapImageGenerator.makeGaugeAndWriteToFile();
        assertTrue("Test call resulted in expected outcome", true);
    }
    
    public void testMakeGaugeAndWriteToFile2() throws Throwable {
        NewCrapImageGenerator newCrapImageGenerator = new NewCrapImageGenerator(1.0F, "testNewCrapImageGeneratorParam2", "testNewCrapImageGeneratorParam3", true, 0.0F);
        newCrapImageGenerator.makeGaugeAndWriteToFile();
        assertTrue("Test call resulted in expected outcome", true);
    }
    ...
    public void testMakeGaugeAndWriteToFile4() throws Throwable {
        NewCrapImageGenerator newCrapImageGenerator = new NewCrapImageGenerator(100.0F, "testNewCrapImageGeneratorParam2", "testNewCrapImageGeneratorParam3", false, 1000.0F);
        newCrapImageGenerator.makeGaugeAndWriteToFile();
        assertTrue("Test call resulted in expected outcome", true);
    }
    
    public void testMakeGaugeAndWriteToFile5() throws Throwable {
        NewCrapImageGenerator newCrapImageGenerator = new NewCrapImageGenerator(0.0F, "testNewCrapImageGeneratorParam2", "testNewCrapImageGeneratorParam3", false, 100.0F);
        newCrapImageGenerator.makeGaugeAndWriteToFile();
        assertTrue("Test call resulted in expected outcome", true);
    }
    
    public void testMakeGaugeAndWriteToFile6() throws Throwable {
        NewCrapImageGenerator newCrapImageGenerator = new NewCrapImageGenerator(-1.0F, "testNewCrapImageGeneratorParam2", "testNewCrapImageGeneratorParam3", false, 100.0F);
        newCrapImageGenerator.makeGaugeAndWriteToFile();
        assertTrue("Test call resulted in expected outcome", true);
    }
    
    public void testMakeGaugeAndWriteToFile7() throws Throwable {
        NewCrapImageGenerator newCrapImageGenerator = new NewCrapImageGenerator(1000.0F, "testNewCrapImageGeneratorParam2", "testNewCrapImageGeneratorParam3", true, 100.0F);
        newCrapImageGenerator.makeGaugeAndWriteToFile();
        assertTrue("Test call resulted in expected outcome", true);
    }
    
    public void testMakeGaugeAndWriteToFile8() throws Throwable {
        NewCrapImageGenerator newCrapImageGenerator = new NewCrapImageGenerator(15.030015F, "testNewCrapImageGeneratorParam2", "testNewCrapImageGeneratorParam3", true, 0.0F);
        newCrapImageGenerator.makeGaugeAndWriteToFile();
        assertTrue("Test call resulted in expected outcome", true);
    }
    
    public void testMakeGaugeAndWriteToFile9() throws Throwable {
        NewCrapImageGenerator newCrapImageGenerator = new NewCrapImageGenerator(1000.0F, "testNewCrapImageGeneratorParam2", "testNewCrapImageGeneratorParam3", false, 100.0F);
        newCrapImageGenerator.makeGaugeAndWriteToFile();
        assertTrue("Test call resulted in expected outcome", true);
    }
    
    public void testMakeGaugeAndWriteToFile10() throws Throwable {
        NewCrapImageGenerator newCrapImageGenerator = new NewCrapImageGenerator(100.0F, "testNewCrapImageGeneratorParam2", "testNewCrapImageGeneratorParam3", true, 1000.0F);
        newCrapImageGenerator.makeGaugeAndWriteToFile();
        assertTrue("Test call resulted in expected outcome", true);
    }
    ...
    public void testWriteImageToFile() throws Throwable {
        NewCrapImageGenerator newCrapImageGenerator = new NewCrapImageGenerator(100.0F, "testNewCrapImageGeneratorDir", "testNewCrapImageGeneratorFilename", true, 1000.0F);
        BufferedImage gauge = (BufferedImage) callPrivateMethod("org.crap4j.gauge.NewCrapImageGenerator", "makeGauge", new Class[] {}, newCrapImageGenerator, new Object[] {});
        NewCrapImageGenerator newCrapImageGenerator2 = new NewCrapImageGenerator(1000.0F, "testNewCrapImageGeneratorDir1", "testNewCrapImageGeneratorFilename1", false, 0.0F);
        callPrivateMethod("org.crap4j.gauge.NewCrapImageGenerator", "writeImageToFile", new Class[] {BufferedImage.class}, newCrapImageGenerator2, new Object[] {gauge});
        assertTrue("Test call resulted in expected outcome", true);
    }
    ...
    public void testDrawMarkerThrowsNullPointerException1() throws Throwable {
        NewCrapImageGenerator newCrapImageGenerator = new NewCrapImageGenerator(100.0F, "testNewCrapImageGeneratorDir", "testNewCrapImageGeneratorFilename", true, 1000.0F);
        try {
            callPrivateMethod("org.crap4j.gauge.NewCrapImageGenerator", "drawMarker", new Class[] {int.class, int.class, Graphics2D.class, float.class, int.class}, newCrapImageGenerator, new Object[] {new Integer(100), new Integer(1000), null, new Float(-0.0010F), new Integer(0)});
            fail("Expected NullPointerException to be thrown");
        } catch (NullPointerException ex) {
            assertNull("ex.getMessage()", ex.getMessage());
            assertThrownBy(NewCrapImageGenerator.class, ex);
    ...
    public void testMainThrowsArrayIndexOutOfBoundsException() throws Throwable {
        ...
        Mockingbird.enterRecordingMode();
        callPrivateMethod("org.crap4j.gauge.NewCrapImageGenerator", "validateArgs", new Class[] {String[].class}, null, new Object[] {argv});
        Mockingbird.setNormalReturnForVoid();
    ...
    public void testMainThrowsNullPointerException() throws Throwable {
        ...
        argv[1] = "Could not access Gr>phics Environment: ";
        argv[2] = "testString";
        try {
            NewCrapImageGenerator.main(argv);
            fail("Expected NullPointerException to be thrown");
    ...
    public void testMainThrowsNumberFormatException() throws Throwable {
        ...
        try {
            ...
            assertEquals("ex.getMessage()", "For input string: \"Unknown image typ)e\"", ex.getMessage());
        }
    }
    ...
    public void testMainThrowsNumberFormatException2() throws Throwable {
        String[] argv = new String[5];
        argv[0] = "\u6FC4\u2B32\uA52C\u209F\uD2AB\u1442\uD92D\u1323\u5D5B\uCEDE\uDB56";
        argv[1] = "formatNae == null!";
        try {
            ...
            assertEquals("ex.getMessage()", "For input string: \"\u6FC4\u2B32\uA52C\u209F\uD2AB\u1442\uD92D\u1323\u5D5B\uCEDE\uDB56\"", ex.getMessage());
        }
    }
}
