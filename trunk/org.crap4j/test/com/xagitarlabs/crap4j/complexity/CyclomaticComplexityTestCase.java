package com.xagitarlabs.crap4j.complexity;

import java.io.File;
import java.util.List;

import com.xagitarlabs.crap4j.MethodComplexity;
import com.xagitarlabs.crap4j.MethodInfo;
...
public class CyclomaticComplexityTestCase extends TestCase {
	...
	public void testComplexity() throws Exception {
		String file = getClass().getClassLoader().getResource("com/xagitarlabs/crap4j/complexity/ComplexitySubject1TestFixture.class").getFile();
