 ...
 *
 * Generated on Nov 6, 2007 1:40:06 PM
 * Time to generate: 02:58.633 seconds
 *
 */
...
public class Crap4jAntTaskAgitarTest extends AgitarTestCase {
    ...
    public void testCreateSrcDirsWithAggressiveMocks() throws Throwable {
        ...
        Mockingbird.setReturnValue(path.createPath(), null);
    ...
    public void testSetDownloadAveragesWithAggressiveMocks() throws Throwable {
        Crap4jAntTask crap4jAntTask = (Crap4jAntTask) Mockingbird.getProxyObject(Crap4jAntTask.class, true);
        Mockingbird.enterTestMode(Crap4jAntTask.class);
        crap4jAntTask.setDownloadAverages(false);
        assertFalse("crap4jAntTask.isDownloadAverages()", crap4jAntTask.isDownloadAverages());
    }
    ...
    public void testSetServer() throws Throwable {
        Crap4jAntTask crap4jAntTask = new Crap4jAntTask();
        crap4jAntTask.setServer("testCrap4jAntTaskServer");
        assertEquals("crap4jAntTask.getServer()", "testCrap4jAntTaskServer", crap4jAntTask.getServer());
    }
    ...
    public void testStringOf() throws Throwable {
        Crap4jAntTask crap4jAntTask = new Crap4jAntTask();
        String result = (String) callPrivateMethod("org.crap4j.anttask.Crap4jAntTask", "stringOf", new Class[] {Path.class}, crap4jAntTask, new Object[] {new Crap4jAntTask().createTestClassDirs()});
    ...
    public void testCreateCrapProjectThrowsBuildException() throws Throwable {
        ...
        crap4jAntTask.setLibClasspath(path);
        Mockingbird.enterRecordingMode();
        Mockingbird.setReturnValue(false, projectDir, "getAbsolutePath", "()java.lang.String", new Object[] {}, "/home/agitar/work/sexy-dolphin-02-agitar-1/c6492d4027d5ae4375e31b1fec305c9e/org.crap4j/testString", 1);
    ...
    public void testCreateCrapProjectThrowsBuildException1() throws Throwable {
        ...
        Mockingbird.enterRecordingMode();
        Mockingbird.setReturnValue(false, projectDir, "getAbsolutePath", "()java.lang.String", new Object[] {}, "/home/agitar/work/sexy-dolphin-02-agitar-1/c6492d4027d5ae4375e31b1fec305c9e/org.crap4j/testCrap4jAntTaskParam1", 1);
        String[] strings = new String[1];
        strings[0] = "/home/agitar/work/sexy-dolphin-02-agitar-1/c6492d4027d5ae4375e31b1fec305c9e/org.crap4j/testString";
    ...
    public void testExecuteThrowsBuildException() throws Throwable {
        ...
        try {
            ...
            assertNull("crap4jAntTask.getServer()", crap4jAntTask.getServer());
    ...
    public void testExecuteThrowsBuildException1() throws Throwable {
        ...
        crap4jAntTask.setTestClassDirs(path);
        Path path2 = (Path) Mockingbird.getProxyObject(Path.class);
        crap4jAntTask.setSrcDirs(path2);
        File projectDir = (File) Mockingbird.getProxyObject(File.class);
        crap4jAntTask.setProjectDir(projectDir);
        Path path3 = (Path) Mockingbird.getProxyObject(Path.class);
        crap4jAntTask.setLibClasspath(path3);
        Path path4 = (Path) Mockingbird.getProxyObject(Path.class);
        crap4jAntTask.setClassDirs(path4);
        Mockingbird.enterRecordingMode();
        Mockingbird.setReturnValue(false, projectDir, "getAbsolutePath", "()java.lang.String", new Object[] {}, "/home/agitar/work/sexy-dolphin-02-agitar-1/c6492d4027d5ae4375e31b1fec305c9e/org.crap4j/testCrap4jAntTaskParam1", 1);
        String[] strings = new String[0];
        Mockingbird.setReturnValue(path3.list(), strings);
        ...
        Mockingbird.setReturnValue(path4.list(), strings3);
        ...
        try {
            ...
            assertFalse("crap4jAntTask.isDontTest()", crap4jAntTask.isDontTest());
            assertNull("crap4jAntTask.getServer()", crap4jAntTask.getServer());
            assertSame("crap4jAntTask.getClassDirs()", path4, crap4jAntTask.getClassDirs());
            assertSame("crap4jAntTask.getTestClassDirs()", path, crap4jAntTask.getTestClassDirs());
            assertNull("crap4jAntTask.getOutputDir()", crap4jAntTask.getOutputDir());
            assertSame("crap4jAntTask.getSrcDirs()", path2, crap4jAntTask.getSrcDirs());
            assertSame("crap4jAntTask.getLibClasspath()", path3, crap4jAntTask.getLibClasspath());
    ...
    public void testExecuteThrowsNullPointerException5() throws Throwable {
        Crap4jAntTask crap4jAntTask = new Crap4jAntTask();
        Path path = (Path) Mockingbird.getProxyObject(Path.class);
        crap4jAntTask.setTestClassDirs(path);
        File projectDir = (File) Mockingbird.getProxyObject(File.class);
