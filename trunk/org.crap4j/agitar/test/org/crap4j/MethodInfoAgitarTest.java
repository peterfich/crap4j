 ...
 * Time to generate: 00:17.239 seconds
 *
 */
...
public class MethodInfoAgitarTest extends AgitarTestCase {
    ...
    public void testCompareToThrowsNullPointerException() throws Throwable {
        MethodComplexity complexity2 = new MethodComplexity("testMethodInfoParam1", "testMethodInfoParam2", "testMethodInfoParam3", "testMethodInfoParam4", "testMethodInfoParam5", 100, "testMethodInfoParam7");
        MethodComplexity complexity2_2 = new MethodComplexity("testMethodInfoParam11", "testMethodInfoParam21", "testMethodInfoParam31", "testMethodInfoParam41", "testMethodInfoParam51", 1000, "testMethodInfoParam71");
        MethodInfo methodCrap = new MethodCrap("testMethodInfoMethodSignature", 0.0F, complexity2_2);
        try {
            methodCrap.compareTo(new MethodCrap(null, 1.0F, complexity2));
            fail("Expected NullPointerException to be thrown");
        } catch (NullPointerException ex) {
            assertNull("ex.getMessage()", ex.getMessage());
            assertThrownBy(String.class, ex);
            assertEquals("(MethodCrap) methodCrap.matchingMethodSignature", "testMethodInfoMethodSignature", ((MethodCrap) methodCrap).matchingMethodSignature);
        }
    }
