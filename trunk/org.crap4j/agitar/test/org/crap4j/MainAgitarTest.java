 ...
 * Time to generate: 00:30.383 seconds
 *
 */
...
public class MainAgitarTest extends AgitarTestCase {
    ...
    public void testCreateMain2() throws Throwable {
        ...
        Mockingbird.setReturnValue(false, "", "replace", "(java.lang.CharSequence,java.lang.CharSequence)java.lang.String", new Object[] {"%20", " "}, "", 1);
    ...
    public void testIsAbsoluteWindowsPath1() throws Throwable {
        boolean result = ((Boolean) callPrivateMethod("org.crap4j.Main", "isAbsoluteWindowsPath", new Class[] {String.class}, null, new Object[] {":w"})).booleanValue();
    ...
    public void testMainWithAggressiveMocks() throws Throwable {
        ...
        options.setDownloadAverages(false);
        Mockingbird.enterRecordingMode();
        ...
        Mockingbird.setReturnValue(options.getServer(), "");
    ...
    public void testPrintUsage() throws Throwable {
        CmdLineParser cmdLineParser = new CmdLineParser(new Integer(0));
    ...
    public void testRunWithAggressiveMocks() throws Throwable {
        Main main = (Main) Mockingbird.getProxyObject(Main.class, true);
        Mockingbird.enterRecordingMode();
        Mockingbird.replaceObjectForRecording(AntSuperrunnerCoverageStrategy.class, "<init>(org.crap4j.Main)", Mockingbird.getProxyObject(AntSuperrunnerCoverageStrategy.class));
        Crap4jRunner crap4jRunner = (Crap4jRunner) Mockingbird.getProxyObject(Crap4jRunner.class);
        Mockingbird.replaceObjectForRecording(Crap4jRunner.class, "<init>(boolean,boolean,boolean,org.crap4j.CoverageGeneratorStrategy,float,float,float,java.lang.String)", crap4jRunner);
        crap4jRunner.doProject(null);
        Mockingbird.setNormalReturnForVoid();
        Mockingbird.enterTestMode(Main.class);
        main.run(null, false, false, false, "");
        assertTrue("Test call resulted in expected outcome", true);
    }
    ...
    public void testRunThrowsNullPointerException() throws Throwable {
        ...
        try {
            main.run(null, true, false, false, "testMainParam5");
            fail("Expected NullPointerException to be thrown");
        } catch (NullPointerException ex) {
            assertNull("ex.getMessage()", ex.getMessage());
