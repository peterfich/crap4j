 ...
 *
 * Generated on Nov 6, 2007 1:39:36 PM
 * Time to generate: 00:28.129 seconds
 *
 */
...
public class MainAgitarTest extends AgitarTestCase {
    ...
    public void testIsAbsoluteWindowsPath2() throws Throwable {
        boolean result = ((Boolean) callPrivateMethod("org.crap4j.Main", "isAbsoluteWindowsPath", new Class[] {String.class}, null, new Object[] {"\\N:s?;tLUrd)5\\3]yB6.19YP!Y;Vs(Sb6#<T"})).booleanValue();
    ...
    public void testRun() throws Throwable {
        ...
        main.run(null, true, true, false, "testMainServer");
        assertTrue("Test call resulted in expected outcome", true);
    }
    ...
    public void testRunThrowsNullPointerException() throws Throwable {
        Main main = Main.createMain("testMainCrap4jHome", "testMainAgitatorEclipseApiPlugin", "testMainAgitatorEclipseCoveragePluginDir", "testMainJunitLib", "testMainAntHome");
        try {
            main.run(null, true, false, true, "testMainServer");
            fail("Expected NullPointerException to be thrown");
        } catch (NullPointerException ex) {
            assertNull("ex.getMessage()", ex.getMessage());
