 ...
 *
 * Generated on Nov 1, 2007 12:03:32 AM
 * Time to generate: 01:30.584 seconds
 *
 */
...
public class MethodCrapAgitarTest extends AgitarTestCase {
    ...
    public void testConstructor4() throws Throwable {
        MethodComplexity methodComplexity = new MethodComplexity("testMethodCrapParam1", "testMethodCrapParam2", "testMethodCrapParam3", "testMethodCrapParam4", "testMethodCrapParam5", 1, "testMethodCrapParam7");
        MethodCrap methodCrap = new MethodCrap("testMethodCrapParam1", 0.0010F, methodComplexity);
        assertSame("methodCrap.complexity", methodComplexity, getPrivateField(methodCrap, "complexity"));
    ...
    public void testFindSameMethod() throws Throwable {
        MethodComplexity complexity2 = new MethodComplexity("testMethodCrapMethodSignature", "testMethodCrapPkgclassName", "testMethodCrapMethodName", "testMethodCrapMethodDescriptor", "testMethodCrapJava5Signature", 100, "testMethodCrapPrettyMethodSignature");
        Object result = callPrivateMethod("org.crap4j.MethodCrap", "findSameMethod", new Class[] {List.class, MethodInfo.class}, null, new Object[] {new ArrayList(100), new MethodCrap("testMethodCrapMethodSignature", 0.0F, complexity2)});
    ...
    public void testFindSameMethod1() throws Throwable {
        List arrayList = new ArrayList(100);
        MethodComplexity complexity2 = new MethodComplexity("testMethodCrapMethodSignature", "testMethodCrapPkgclassName", "testMethodCrapMethodName", "testMethodCrapMethodDescriptor", "testMethodCrapJava5Signature", 100, "testMethodCrapPrettyMethodSignature");
        arrayList.add(new MethodCrap("testMethodCrapMethodSignature1", 0.0F, complexity2));
    ...
    public void testFindSameMethod2() throws Throwable {
        MethodComplexity complexity2 = new MethodComplexity("testMethodCrapMethodSignature", "testMethodCrapPkgclassName", "testMethodCrapMethodName", "testMethodCrapMethodDescriptor", "testMethodCrapJava5Signature", 100, "testMethodCrapPrettyMethodSignature");
        MethodInfo methodCrap = new MethodCrap("testString", 0.0F, complexity2);
        List arrayList = new ArrayList(100);
        MethodCoverage methodCoverage = new MethodCoverage("testString", 100.0F);
        arrayList.add(methodCoverage);
        MethodCoverage result = (MethodCoverage) callPrivateMethod("org.crap4j.MethodCrap", "findSameMethod", new Class[] {List.class, MethodInfo.class}, null, new Object[] {arrayList, methodCrap});
    ...
    public void testFindSameMethod3() throws Throwable {
        MethodComplexity complexity2 = new MethodComplexity("testMethodCrapMethodSignature", "testMethodCrapPkgclassName", "testMethodCrapMethodName", "testMethodCrapMethodDescriptor", "testMethodCrapJava5Signature", 100, "testMethodCrapPrettyMethodSignature");
        MethodInfo methodCrap = new MethodCrap("testMethodCrapMethodSignature", 0.0F, complexity2);
        List arrayList = new ArrayList(100);
        ...
        MethodInfo result = (MethodInfo) callPrivateMethod("org.crap4j.MethodCrap", "findSameMethod", new Class[] {List.class, MethodInfo.class}, null, new Object[] {arrayList, methodCrap});
    ...
    public void testPrettyMethodSignature1() throws Throwable {
        MethodComplexity complexity2 = new MethodComplexity("testMethodCrapMethodSignature", "testMethodCrapPkgclassName", "testMethodCrapMethodName", "testMethodCrapMethodDescriptor", "testMethodCrapJava5Signature", 100, null);
    ...
    public void testConstructorThrowsIllegalArgumentException() throws Throwable {
        MethodComplexity methodComplexity = new MethodComplexity("testMethodCrapParam1", "testMethodCrapParam2", "testMethodCrapParam3", "testMethodCrapParam4", "testMethodCrapParam5", -1, "testMethodCrapParam7");
        try {
            new MethodCrap("testMethodCrapParam1", 1.0F, methodComplexity);
    ...
    public void testConstructorThrowsIllegalArgumentException1() throws Throwable {
        try {
            new MethodCrap("testMethodCrapMethodSignature", 0.999F, null);
            fail("Expected IllegalArgumentException to be thrown");
        } catch (IllegalArgumentException ex) {
            assertEquals("ex.getMessage()", "coverage is 0 or greater and complexity is 0 (really 1) or greater", ex.getMessage());
            assertThrownBy(MethodCrap.class, ex);
    ...
    public void testCombineThrowsIllegalArgumentException1() throws Throwable {
        ...
        Mockingbird.setReturnValue(methodComplexity.getMatchingMethodSignature(), "\ny=.SKyuv-.testStringtestString");
        ...
        Mockingbird.setReturnValue(methodComplexity3.getMatchingMethodSignature(), "mX9@\u000B.testStringtestString");
        Mockingbird.replaceObjectForRecording(MethodCrap.class, "<init>(java.lang.String,float,org.crap4j.MethodComplexity)", Mockingbird.getProxyObject(MethodCrap.class));
        Mockingbird.setReturnValue(false, arrayList, "add", "(java.lang.Object)boolean", Boolean.TRUE, 1);
        Mockingbird.setReturnValue(false, iterator, "hasNext", "()boolean", new Object[] {}, Boolean.TRUE, 1);
        MethodComplexity methodComplexity4 = (MethodComplexity) Mockingbird.getProxyObject(MethodComplexity.class);
        Mockingbird.setReturnValue(false, iterator, "next", "()java.lang.Object", new Object[] {}, methodComplexity4, 1);
        Object sameMethod4 = callPrivateMethod("org.crap4j.MethodCrap", "findSameMethod", new Class[] {List.class, MethodInfo.class}, null, new Object[] {covs, methodComplexity4});
        Mockingbird.setReturnValue(sameMethod4, null);
        Mockingbird.setReturnValue(methodComplexity4.getMatchingMethodSignature(), "testString.testString");
        Mockingbird.setConstructorForException(MethodCrap.class, "<init>(java.lang.String,float,org.crap4j.MethodComplexity)", (Throwable) Mockingbird.getProxyObject(IllegalArgumentException.class));
        Mockingbird.enterTestMode(MethodCrap.class);
        try {
            MethodCrap.combine(covs, complexities);
    ...
    public void testCombineThrowsIllegalArgumentException2() throws Throwable {
        ...
        Object sameMethod = callPrivateMethod("org.crap4j.MethodCrap", "findSameMethod", new Class[] {List.class, MethodInfo.class}, null, new Object[] {covs, methodComplexity});
        Mockingbird.setReturnValue(sameMethod, null);
        Mockingbird.setReturnValue(methodComplexity.getMatchingMethodSignature(), "testString.$BXjQ\r%'H%Ofy%?O\f4_k`ufAEM<testString");
        Mockingbird.setConstructorForException(MethodCrap.class, "<init>(java.lang.String,float,org.crap4j.MethodComplexity)", (Throwable) Mockingbird.getProxyObject(IllegalArgumentException.class));
        Mockingbird.enterTestMode(MethodCrap.class);
        try {
            MethodCrap.combine(covs, complexities);
    ...
    public void testCombineThrowsNullPointerException() throws Throwable {
        ...
        arrayList.add(null);
        try {
            MethodCrap.combine(new ArrayList(100), arrayList);
    ...
    public void testFindSameMethodThrowsNullPointerException2() throws Throwable {
        ...
        List arrayList = new ArrayList(100);
        MethodComplexity methodComplexity2 = new MethodComplexity("testMethodCrapMethodSignature1", "testMethodCrapPkgclassName1", "testMethodCrapMethodName1", "testMethodCrapMethodDescriptor1", "testMethodCrapJava5Signature1", 1000, "testMethodCrapPrettyMethodSignature1");
    ...
    public void testFindSameMethodThrowsNullPointerException3() throws Throwable {
        try {
    ...
    public void testToXmlThrowsNullPointerException() throws Throwable {
        ...
        MethodComplexity complexity2 = new MethodComplexity("testMethodCrapMethodSignature", "testMethodCrapPkgclassName", "testMethodCrapMethodName", null, "", 100, "testMethodCrapPrettyMethodSignature");
        MethodCrap methodCrap = new MethodCrap("testMethodCrapMethodSignature", 0.0F, complexity2);
        try {
            methodCrap.toXml(s);
            fail("Expected NullPointerException to be thrown");
