 ...
 *
 * Generated on Nov 1, 2007 12:01:21 AM
 * Time to generate: 00:41.641 seconds
 *
 */
...
public class FileUtilAgitarTest extends AgitarTestCase {
    ...
    public void testEnsureDirectory1() throws Throwable {
        FileUtil.ensureDirectory("/home/agitar/work/sexy-dolphin-09-agitar-1/tmp/agitar-agitar/Agitator22009.dir/Agitator2415.tmp");
        assertTrue("Test call resulted in expected outcome", true);
    }
    ...
    public void testEnsureNewFile() throws Throwable {
        File file = (File) Mockingbird.getProxyObject(File.class);
        Mockingbird.enterRecordingMode();
        Mockingbird.setReturnValue(file.exists(), false);
        Mockingbird.enterTestMode(FileUtil.class);
    ...
    public void testGetFileNameWithoutExtension1() throws Throwable {
        File file = new File("/home/agitar/work/sexy-dolphin-09-agitar-1/tmp/agitar-agitar/Agitator22009pdir/Agitator1697.tmp");
        ...
        assertEquals("result", "Agitator1697", result);
    }
    ...
    public void testHasTestClassFiles5() throws Throwable {
    ...
    public void testIsTestFile() throws Throwable {
        boolean result = ((Boolean) callPrivateMethod("org.crap4j.util.FileUtil", "isTestFile", new Class[] {String.class}, null, new Object[] {"\uA57F\u80B1Test"})).booleanValue();
        assertTrue("result", result);
    }
    ...
    public void testIsTestFile2() throws Throwable {
        boolean result = ((Boolean) callPrivateMethod("org.crap4j.util.FileUtil", "isTestFile", new Class[] {String.class}, null, new Object[] {"AgitarTest:%l{.1Ee0Ma@UsnsX.bW;%!B{nP:O_+@h+]rkE"})).booleanValue();
        assertTrue("result", result);
    }
    
    public void testIsTestFile3() throws Throwable {
        boolean result = ((Boolean) callPrivateMethod("org.crap4j.util.FileUtil", "isTestFile", new Class[] {String.class}, null, new Object[] {"Test\u62A4\uB080\u3DB0\u784A\u83A2\u193E\u3108\uB687\u9D9D\u9557Ï\uEC77\u79A3\u0DE6\u5046\uF270\u09E0\u768C\uBF1B\u071E\u444C\u6F74\u57F5\u7D2C\u6BAF\u2637\uCE39\uF511\uAE40\u5F9F\uD483\uC0F4\u9649"})).booleanValue();
        assertTrue("result", result);
    }
    ...
    public void testPassesFilter() throws Throwable {
        File file = (File) Mockingbird.getProxyObject(File.class);
        Mockingbird.enterTestMode(FileUtil.class);
        boolean result = ((Boolean) callPrivateMethod("org.crap4j.util.FileUtil", "passesFilter", new Class[] {File.class, FilenameFilter.class, File.class}, null, new Object[] {file, null, file})).booleanValue();
        assertTrue("result", result);
    }
    ...
    public void testRemoveTestClassFiles1() throws Throwable {
        List arrayList = new ArrayList(100);
        File file = new File("testFileUtilParam1");
        File file2 = new File("/home/agitar/work/sexy-dolphin-09-agitar-1/tmp/agitar-agitar/Agitator22009pdir/Agitator1697.tmp");
        arrayList.add(file);
        arrayList.add(file2);
        ArrayList result = (ArrayList) FileUtil.removeTestClassFiles(arrayList);
    ...
    public void testWriteFile1() throws Throwable {
        ...
        BufferedWriter bufferedWriter = (BufferedWriter) Mockingbird.getProxyObject(BufferedWriter.class);
        Mockingbird.replaceObjectForRecording(BufferedWriter.class, "<init>(java.io.Writer)", bufferedWriter);
        Mockingbird.setReturnValue(false, bufferedWriter, "write", "(java.lang.String)void", new Object[] {"h"}, null, 1);
        Mockingbird.setReturnValue(false, bufferedWriter, "close", "()void", new Object[] {}, null, 1);
        Mockingbird.enterTestMode(FileUtil.class);
        FileUtil.writeFile(file, "testFileUtilString");
        assertTrue("Test call resulted in expected outcome", true);
    ...
    public void testHasTestClassFilesThrowsNullPointerException1() throws Throwable {
        List arrayList = new ArrayList(100);
        arrayList.add(new File(new File("testFileUtilParam1"), "testFileUtilParam2"));
        arrayList.add(new File(new File("testFileUtilParam11"), "Agitator37.tmp"));
        arrayList.add(null);
        try {
            FileUtil.hasTestClassFiles(arrayList);
            fail("Expected NullPointerException to be thrown");
    ...
    public void testMakeRelativePathsThrowsStringIndexOutOfBoundsException() throws Throwable {
        ...
        try {
            FileUtil.makeRelativePaths("", arrayList);
