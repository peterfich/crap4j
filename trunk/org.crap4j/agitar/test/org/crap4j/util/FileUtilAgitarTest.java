 ...
 *
 * Generated on Oct 26, 2007 3:59:36 PM
 * Time to generate: 00:45.264 seconds
 *
 */
...
public class FileUtilAgitarTest extends AgitarTestCase {
    ...
    public void testEraseFile() throws Throwable {
        FileUtil.eraseFile("testFileUtilFile");
        assertTrue("Test call resulted in expected outcome", true);
    }
    ...
    public void testGetFileNameWithoutExtension() throws Throwable {
        String result = (String) callPrivateMethod("org.crap4j.util.FileUtil", "getFileNameWithoutExtension", new Class[] {File.class}, null, new Object[] {new File(new File("testFileUtilParam1"), "testFileUtilParam2")});
        assertEquals("result", "testFileUtilParam2", result);
    }
    
    public void testGetFileNameWithoutExtension1() throws Throwable {
        File file = new File("/home/agitar/work/sexy-dolphin-10-agitar-1/tmp/agitar-agitar/Agitator51022wdir/Agitator5.tmp");
        ...
        assertEquals("result", "Agitator5", result);
    }
    ...
    public void testHasTestClassFiles() throws Throwable {
        ...
        File file = new File("/home/agitar/work/sexy-dolphin-10-agitar-1/tmp/agitar-agitar/Agitator51022wdir/Agitator5.tmp");
        files.add(file);
        boolean result = FileUtil.hasTestClassFiles(files);
    ...
    public void testHasTestClassFiles2() throws Throwable {
        ...
        File file = new File("/home/agitar/work/sexy-dolphin-10-agitar-1/tmp/agitar-agitar/Agitator51022wdir/Agitator5.tmp");
        files.add(file);
        files.add(new File("testFileUtilParam11"));
        boolean result = FileUtil.hasTestClassFiles(files);
        assertFalse("result", result);
    }
    ...
    public void testIsAbsolute() throws Throwable {
        boolean result = FileUtil.isAbsolute("testFileUtilPath");
        assertFalse("result", result);
    }
    ...
    public void testIsTestFile1() throws Throwable {
        boolean result = ((Boolean) callPrivateMethod("org.crap4j.util.FileUtil", "isTestFile", new Class[] {String.class}, null, new Object[] {"Test\\YNyW=<J]Vc4Bhao\u001Eu.s|)*\u0006c[\u000FX"})).booleanValue();
        assertTrue("result", result);
    }
    
    public void testIsTestFile2() throws Throwable {
        boolean result = ((Boolean) callPrivateMethod("org.crap4j.util.FileUtil", "isTestFile", new Class[] {String.class}, null, new Object[] {"AgitarTest\u77CA"})).booleanValue();
        assertTrue("result", result);
    }
    ...
    public void testJoinPath() throws Throwable {
        String result = FileUtil.joinPath("testFileUtilBasePath", "testFileUtilPath");
        assertEquals("result", new File("testFileUtilBasePath/testFileUtilPath").getAbsolutePath(), result);
    }
    ...
    public void testMakeRelativePaths() throws Throwable {
        ArrayList result = (ArrayList) FileUtil.makeRelativePaths("testFileUtilClassDir", new ArrayList(100));
    ...
    public void testMakeRelativePaths1() throws Throwable {
        List files = new ArrayList(100);
        files.add(new File("testFileUtilParam1"));
        ArrayList result = (ArrayList) FileUtil.makeRelativePaths("", files);
        assertEquals("result.size()", 1, result.size());
        assertEquals("(ArrayList) result.get(0)", "estFileUtilParam1", result.get(0));
    }
    
    public void testPassesFilter() throws Throwable {
        boolean result = ((Boolean) callPrivateMethod("org.crap4j.util.FileUtil", "passesFilter", new Class[] {File.class, FilenameFilter.class, File.class}, null, new Object[] {new File("testFileUtilParam11"), null, new File("testFileUtilParam1")})).booleanValue();
        assertTrue("result", result);
    }
    ...
    public void testRemoveTestClassFiles() throws Throwable {
        ...
        File file = new File("/home/agitar/work/sexy-dolphin-10-agitar-1/tmp/agitar-agitar/Agitator51022wdir/Agitator5.tmp");
        files.add(file);
        ArrayList result = (ArrayList) FileUtil.removeTestClassFiles(files);
        assertEquals("result.size()", 1, result.size());
    ...
    public void testRemoveTestClassFiles1() throws Throwable {
        ...
        File file2 = new File("/home/agitar/work/sexy-dolphin-10-agitar-1/tmp/agitar-agitar/Agitator51022wdir/Agitator5.tmp");
        files.add(file);
        files.add(file2);
        ArrayList result = (ArrayList) FileUtil.removeTestClassFiles(files);
    ...
    public void testRemoveTestClassFiles4() throws Throwable {
        ...
        Mockingbird.setReturnValue(false, Mockingbird.getProxyObject(String.class), "endsWith", "(java.lang.String)boolean", boolean2, 1);
        Mockingbird.setReturnValue(false, Mockingbird.getProxyObject(String.class), "startsWith", "(java.lang.String)boolean", boolean2, 1);
        Mockingbird.setReturnValue(arrayList.add(file), false);
        Mockingbird.setReturnValue(iterator.hasNext(), true);
        Mockingbird.setReturnValue(iterator.next(), file2);
        Mockingbird.setReturnValue(false, file2, "getName", "()java.lang.String", new Object[] {}, "", 1);
        Mockingbird.setReturnValue(false, Mockingbird.getProxyObject(String.class), "lastIndexOf", "(int)int", new Integer(0), 1);
    ...
    public void testGetAllFilesInDirMatchingPatternThrowsIllegalArgumentException() throws Throwable {
        try {
            FileUtil.getAllFilesInDirMatchingPattern("testFileUtilDirectory", "testFileUtilRegex", true);
            fail("Expected IllegalArgumentException to be thrown");
        } catch (IllegalArgumentException ex) {
            assertEquals("ex.getMessage()", new File("testFileUtilDirectory").getAbsolutePath() + " is not a directory", ex.getMessage());
            assertThrownBy(FileUtil.class, ex);
        }
    }
    
    public void testGetAllFilesInDirMatchingPatternThrowsIllegalArgumentException1() throws Throwable {
        Mockingbird.enterRecordingMode();
        callPrivateMethod("org.crap4j.util.FileUtil", "checkDirectory", new Class[] {File.class}, null, new Object[] {null});
        Mockingbird.setExceptionForVoid(true, (Throwable) Mockingbird.getProxyObject(IllegalArgumentException.class));
        Mockingbird.enterTestMode(FileUtil.class);
        try {
            FileUtil.getAllFilesInDirMatchingPattern("testFileUtilDirectory", "testFileUtilRegex", true);
            fail("Expected IllegalArgumentException to be thrown");
    ...
    public void testGetAllFilesInDirMatchingPatternThrowsNullPointerException() throws Throwable {
        try {
            FileUtil.getAllFilesInDirMatchingPattern(null, "testFileUtilRegex", true);
            fail("Expected NullPointerException to be thrown");
        } catch (NullPointerException ex) {
            assertNull("ex.getMessage()", ex.getMessage());
            assertThrownBy(File.class, ex);
    ...
    public void testHasTestClassFilesThrowsNullPointerException() throws Throwable {
        ...
        try {
            ...
            assertNull("ex.getMessage()", ex.getMessage());
            assertThrownBy(FileUtil.class, ex);
            assertEquals("(ArrayList) files.size()", 2, files.size());
        }
    }
    
    public void testHasTestClassFilesThrowsNullPointerException1() throws Throwable {
        List files = new ArrayList(100);
        files.add(new File(new File("testFileUtilParam1"), "testFileUtilParam2"));
        files.add(new File(new File("testFileUtilParam11"), "Agitator37.tmp"));
        files.add(null);
        try {
            FileUtil.hasTestClassFiles(files);
            fail("Expected NullPointerException to be thrown");
    ...
    public void testHasTestClassFilesThrowsNullPointerException2() throws Throwable {
        ...
        File file = (File) Mockingbird.getProxyObject(File.class);
        Mockingbird.setReturnValue(false, iterator, "next", "()java.lang.Object", new Object[] {}, file, 1);
        Object fileNameWithoutExtension = callPrivateMethod("org.crap4j.util.FileUtil", "getFileNameWithoutExtension", new Class[] {File.class}, null, new Object[] {file});
        Mockingbird.setReturnValue(fileNameWithoutExtension, "Agitator79511");
        boolean testFile = ((Boolean) callPrivateMethod("org.crap4j.util.FileUtil", "isTestFile", new Class[] {String.class}, null, new Object[] {"Agitator79511"})).booleanValue();
        Mockingbird.setReturnValue(testFile, false);
        Mockingbird.setReturnValue(false, iterator, "hasNext", "()boolean", new Object[] {}, Boolean.TRUE, 1);
        File file2 = (File) Mockingbird.getProxyObject(File.class);
        Mockingbird.setReturnValue(false, iterator, "next", "()java.lang.Object", new Object[] {}, file2, 1);
        Object fileNameWithoutExtension2 = callPrivateMethod("org.crap4j.util.FileUtil", "getFileNameWithoutExtension", new Class[] {File.class}, null, new Object[] {file2});
        Mockingbird.setReturnValue(fileNameWithoutExtension2, "java.\"o");
        boolean testFile2 = ((Boolean) callPrivateMethod("org.crap4j.util.FileUtil", "isTestFile", new Class[] {String.class}, null, new Object[] {"java.\"o"})).booleanValue();
        Mockingbird.setReturnValue(testFile2, false);
        Mockingbird.setReturnValue(false, iterator, "hasNext", "()boolean", new Object[] {}, Boolean.TRUE, 1);
    ...
    public void testJoinPathThrowsNullPointerException() throws Throwable {
        try {
            FileUtil.joinPath("testFileUtilBasePath", null);
            fail("Expected NullPointerException to be thrown");
        } catch (NullPointerException ex) {
            assertNull("ex.getMessage()", ex.getMessage());
            assertThrownBy(File.class, ex);
    ...
    public void testMakeRelativePathsThrowsNullPointerException1() throws Throwable {
        ...
        files.add(new File("testFileUtilParam1"));
        try {
            FileUtil.makeRelativePaths(null, files);
            fail("Expected NullPointerException to be thrown");
        } catch (NullPointerException ex) {
            assertNull("ex.getMessage()", ex.getMessage());
            assertThrownBy(FileUtil.class, ex);
    ...
    public void testMakeRelativePathsThrowsNullPointerException2() throws Throwable {
        try {
            FileUtil.makeRelativePaths("testFileUtilClassDir", null);
            fail("Expected NullPointerException to be thrown");
        } catch (NullPointerException ex) {
            assertNull("ex.getMessage()", ex.getMessage());
            assertThrownBy(FileUtil.class, ex);
    ...
    public void testMakeRelativePathsThrowsStringIndexOutOfBoundsException() throws Throwable {
        ...
        try {
            ...
            assertEquals("ex.getMessage()", "String index out of range: -21", ex.getMessage());
            assertThrownBy(String.class, ex);
            assertEquals("(ArrayList) files.size()", 1, files.size());
        }
    }
    
    public void testMakeRelativePathsThrowsStringIndexOutOfBoundsException1() throws Throwable {
        List files = new ArrayList(100);
        files.add(new File("testFileUtilParam11"));
        files.add(new File(""));
        try {
            FileUtil.makeRelativePaths("", files);
            fail("Expected StringIndexOutOfBoundsException to be thrown");
        } catch (StringIndexOutOfBoundsException ex) {
    ...
    public void testReadFileThrowsNullPointerException() throws Throwable {
        try {
            FileUtil.readFile("testFileUtilFilename");
            fail("Expected NullPointerException to be thrown");
        } catch (NullPointerException ex) {
            assertNull("ex.getMessage()", ex.getMessage());
            assertThrownBy(FileUtil.class, ex);
    ...
    public void testWriteFileThrowsNullPointerException() throws Throwable {
        try {
            FileUtil.writeFile((File) null, "testFileUtilString");
            fail("Expected NullPointerException to be thrown");
        } catch (NullPointerException ex) {
            assertNull("ex.getMessage()", ex.getMessage());
            assertThrownBy(FileUtil.class, ex);
    ...
    public void testWriteFileThrowsNullPointerException4() throws Throwable {
        File file = (File) Mockingbird.getProxyObject(File.class);
        Mockingbird.enterRecordingMode();
        callPrivateMethod("org.crap4j.util.FileUtil", "ensureNewFile", new Class[] {File.class}, null, new Object[] {file});
        Mockingbird.setNormalReturnForVoid();
    ...
    public void testWriteFileThrowsNullPointerException5() throws Throwable {
        try {
            FileUtil.writeFile((String) null, "testFileUtils");
            fail("Expected NullPointerException to be thrown");
        } catch (NullPointerException ex) {
            assertNull("ex.getMessage()", ex.getMessage());
            assertThrownBy(File.class, ex);
