 ...
 *
 * Generated on Nov 27, 2007 5:08:39 PM
 * Time to generate: 00:19.416 seconds
 *
 */
...
public class MyCoveragePointAgitarTest extends AgitarTestCase {
    ...
    public void testSetTimesReached() throws Throwable {
        MyCoveragePoint myCoveragePoint = new MyCoveragePoint(100, 1000, 0, -1);
        boolean result = myCoveragePoint.setTimesReached(-1);
        assertEquals("myCoveragePoint.timesReached", new Integer(-1), getPrivateField(myCoveragePoint, "timesReached"));
    ...
    public void testSetTimesReached2() throws Throwable {
