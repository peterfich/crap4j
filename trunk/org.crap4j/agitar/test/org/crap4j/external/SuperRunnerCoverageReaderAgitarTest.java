 ...
 *
 * Generated on Nov 27, 2007 4:11:14 PM
 * Time to generate: 01:33.895 seconds
 *
 */
...
public class SuperRunnerCoverageReaderAgitarTest extends AgitarTestCase {
    ...
    public void testCreateMethodCoverages4() throws Throwable {
        ...
        arrayList3.add("testString");
        arrayList3.add("testString");
        arrayList3.add("\\tZk\\1ZJPIKhwfpT\f5if");
        Map hashMap = new HashMap(100, 100.0F);
        ...
        assertEquals("(ArrayList) arrayList2.size()", 6, arrayList2.size());
    }
    ...
    public void testCreateMethodCoveragesThrowsClassCastException1() throws Throwable {
        ...
        hashMap.put(integer, new Stack());
        hashMap.put(integer, arrayList);
        try {
            superRunnerCoverageReader.createMethodCoverages(arrayList2, arrayList3, hashMap);
            fail("Expected ClassCastException to be thrown");
        } catch (ClassCastException ex) {
            assertEquals("(ArrayList) arrayList2.size()", 2, arrayList2.size());
            assertEquals("ex.getClass()", ClassCastException.class, ex.getClass());
            assertThrownBy(SuperRunnerCoverageReader.class, ex);
        }
    }
    ...
    public void testCreateMethodCoveragesThrowsNullPointerException() throws Throwable {
        ...
        Mockingbird.enterRecordingMode();
        Mockingbird.setReturnValue(false, methodNames, "size", "()int", new Object[] {}, new Integer(14), 1);
        ...
        ArrayList arrayList = (ArrayList) Mockingbird.getProxyObject(ArrayList.class);
        Mockingbird.setReturnValue(false, covPoints, "get", "(java.lang.Object)java.lang.Object", new Object[] {integer}, arrayList, 1);
        Iterator iterator = (Iterator) Mockingbird.getProxyObject(Iterator.class);
        ...
        Mockingbird.setReturnValue(false, methodNames, "size", "()int", new Object[] {}, new Integer(14), 1);
        Mockingbird.setReturnValue(false, methodNames, "get", "(int)java.lang.Object", new Object[] {new Integer(1)}, "Y.2  (.i-.", 1);
        Integer integer2 = new Integer(1);
        Mockingbird.setReturnValue(true, Integer.class, "valueOf", "(int)java.lang.Integer", new Object[] {new Integer(1)}, integer2, 1);
        ArrayList arrayList2 = (ArrayList) Mockingbird.getProxyObject(ArrayList.class);
        Mockingbird.setReturnValue(false, covPoints, "get", "(java.lang.Object)java.lang.Object", new Object[] {integer2}, arrayList2, 1);
        Iterator iterator2 = (Iterator) Mockingbird.getProxyObject(Iterator.class);
        ...
        Mockingbird.setReturnValue(true, Integer.class, "valueOf", "(int)java.lang.Integer", new Object[] {new Integer(2)}, integer3, 1);
        ArrayList arrayList3 = (ArrayList) Mockingbird.getProxyObject(ArrayList.class);
        Mockingbird.setReturnValue(false, covPoints, "get", "(java.lang.Object)java.lang.Object", new Object[] {integer3}, arrayList3, 1);
        ...
        Mockingbird.setReturnValue(false, methodNames, "size", "()int", new Object[] {}, new Integer(14), 1);
        Mockingbird.setReturnValue(false, methodNames, "get", "(int)java.lang.Object", new Object[] {new Integer(3)}, "@x", 1);
        Integer integer4 = new Integer(3);
        Mockingbird.setReturnValue(true, Integer.class, "valueOf", "(int)java.lang.Integer", new Object[] {new Integer(3)}, integer4, 1);
        ArrayList arrayList4 = (ArrayList) Mockingbird.getProxyObject(ArrayList.class);
        Mockingbird.setReturnValue(false, covPoints, "get", "(java.lang.Object)java.lang.Object", new Object[] {integer4}, arrayList4, 1);
        ...
        Mockingbird.setReturnValue(true, Integer.class, "valueOf", "(int)java.lang.Integer", new Object[] {new Integer(4)}, integer5, 1);
        ArrayList arrayList5 = (ArrayList) Mockingbird.getProxyObject(ArrayList.class);
        Mockingbird.setReturnValue(false, covPoints, "get", "(java.lang.Object)java.lang.Object", new Object[] {integer5}, arrayList5, 1);
        ...
        MyCoveragePoint myCoveragePoint = (MyCoveragePoint) Mockingbird.getProxyObject(MyCoveragePoint.class);
        Mockingbird.setReturnValue(false, iterator5, "next", "()java.lang.Object", new Object[] {}, myCoveragePoint, 1);
        Mockingbird.setReturnValue(myCoveragePoint.getType(), 2);
        Mockingbird.setReturnValue(myCoveragePoint.getTimesReached(), 0);
        Mockingbird.setReturnValue(false, iterator5, "hasNext", "()boolean", new Object[] {}, Boolean.TRUE, 1);
        Mockingbird.setReturnValue(false, iterator5, "next", "()java.lang.Object", new Object[] {}, null, 1);
        Mockingbird.enterTestMode(SuperRunnerCoverageReader.class);
        try {
    ...
    public void testReadThrowsNullPointerException() throws Throwable {
        ...
        DataInput dataInputStream = new DataInputStream(new ByteArrayInputStream("mark/rset not supported".getBytes()));
        try {
            superRunnerCoverageReader.read(dataInputStream);
            fail("Expected NullPointerException to be thrown");
        } catch (NullPointerException ex) {
            assertNull("ex.getMessage()", ex.getMessage());
            assertThrownBy(SuperRunnerCoverageReader.class, ex);
